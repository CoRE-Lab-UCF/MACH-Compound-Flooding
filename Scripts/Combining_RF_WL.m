...
% intergral = The vector with Water Level intensity
...
% Design_NTR = Design_NTR value
% CDF_Lag_RF_pk = CDF of Rainfall lag time distribution WRT. peak surge
% lag_L = Lower bound of CDF when sampling lag time (0-1)
% lag_U = Upper bound of CDF when sampling lag time (0-1)
% WL_Method = Method of Selecting WL curves (Quantile or Linear)
% RF_Method = Method of WL combining RF fields (Quantile or Linear)
% lag_time = the lag time of RF peak wrt NTR peak. If NAN, the emperical
% distribution will be used sample a lag time
