...
%% One event will be manually transfered in to the List dues to its closeness to the search radius (date: 2009/09/19)
...
for i = 1:48
    ...
    for j =1:leng
        ...
        if length(index)>0
            if Time_ntr>731842 && Time_ntr<731844 % Manually added event
